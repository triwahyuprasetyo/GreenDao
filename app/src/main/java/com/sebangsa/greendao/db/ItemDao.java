...
public class ItemDao extends AbstractDao<Item, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property ItemDescription = new Property(2, String.class, "itemDescription", false, "ITEM_DESCRIPTION");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ITEM\" (" + //
                ...
                "\"ITEM_NAME\" TEXT NOT NULL ," + // 1: itemName
                "\"ITEM_DESCRIPTION\" TEXT NOT NULL );"); // 2: itemDescription
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Item entity) {
        ...
        stmt.bindString(2, entity.getItemName());
        stmt.bindString(3, entity.getItemDescription());
    }
    ...
    public Item readEntity(Cursor cursor, int offset) {
        Item entity = new Item( //
            ...
            cursor.getString(offset + 1), // itemName
            cursor.getString(offset + 2) // itemDescription
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Item entity, int offset) {
        ...
        entity.setItemName(cursor.getString(offset + 1));
        entity.setItemDescription(cursor.getString(offset + 2));
     }
